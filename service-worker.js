...
const CACHE='exbrayat-pro-v0.4.0-rapport-corrige';
const ASSETS=['./','./index.html','./style.css?v=0.4.0r','./app.js?v=0.4.0r','./pdf-lib.min.js?v=0.4.0r','./manifest.webmanifest','./icon.svg','./cerfa_15497-04.pdf','./attestation-capacite.pdf','./logo-exbrayat.png'];
