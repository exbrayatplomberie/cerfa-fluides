...
const CACHE='exbrayat-pro-v0.5.0-securite-locale';
const ASSETS=['./','./index.html','./style.css?v=0.5.0','./app.js?v=0.5.0','./pdf-lib.min.js?v=0.5.0','./manifest.webmanifest','./icon.svg','./cerfa_15497-04.pdf','./attestation-capacite.pdf','./logo-exbrayat.png'];
