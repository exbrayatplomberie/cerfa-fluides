...
const CACHE='exbrayat-pro-v0.4.2.2-stable';
const ASSETS=['./','./index.html','./style.css?v=0.4.2.2','./app.js?v=0.4.2.2','./pdf-lib.min.js?v=0.4.2.2','./manifest.webmanifest','./icon.svg','./cerfa_15497-04.pdf','./attestation-capacite.pdf','./logo-exbrayat.png'];
