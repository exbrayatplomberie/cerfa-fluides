...
const CACHE='exbrayat-pro-v0.4.2.8-numero-date-heure';
const ASSETS=['./','./index.html','./style.css?v=0.4.2.8','./app.js?v=0.4.2.8','./pdf-lib.min.js?v=0.4.2.8','./manifest.webmanifest','./icon.svg','./cerfa_15497-04.pdf','./attestation-capacite.pdf','./logo-exbrayat.png'];
