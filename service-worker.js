...
const CACHE='exbrayat-pro-v5.0.0-stable';
const ASSETS=['./','./index.html','./style.css?v=5.0.0','./app.js?v=5.0.0','./pdf-lib.min.js?v=5.0.0','./manifest.webmanifest','./icon.svg','./cerfa_15497-04.pdf','./attestation-capacite.pdf','./logo-exbrayat.png'];
