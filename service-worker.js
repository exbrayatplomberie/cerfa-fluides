...
const CACHE='exbrayat-pro-v0.4.2.7-verrouillage-ipad';
const ASSETS=['./','./index.html','./style.css?v=0.4.2.7','./app.js?v=0.4.2.7','./pdf-lib.min.js?v=0.4.2.7','./manifest.webmanifest','./icon.svg','./cerfa_15497-04.pdf','./attestation-capacite.pdf','./logo-exbrayat.png'];
