...
const CACHE='exbrayat-pro-v0.4.3.1-gaz';
const ASSETS=['./','./index.html','./style.css?v=0.4.3.0','./app.js?v=0.4.2.10','./gaz.js?v=0.4.3.1','./pdf-lib.min.js?v=0.4.2.9','./manifest.webmanifest','./icon.svg','./cerfa_15497-04.pdf','./attestation-capacite.pdf','./logo-exbrayat.png','./pense-bete-mesures-clim-reversible.png'];
