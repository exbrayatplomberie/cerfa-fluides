...
const CACHE='exbrayat-pro-v0.4.1.1-verrouillage-simple';
const ASSETS=['./','./index.html','./style.css?v=0.4.1.1','./app.js?v=0.4.1.1','./pdf-lib.min.js?v=0.4.1.1','./manifest.webmanifest','./icon.svg','./cerfa_15497-04.pdf','./attestation-capacite.pdf','./logo-exbrayat.png'];
